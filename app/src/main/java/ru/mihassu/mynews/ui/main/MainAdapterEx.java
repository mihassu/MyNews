...
public class MainAdapterEx extends ListAdapter<MyArticle, ViewHolderBase> implements IMainAdapter {
    ...
    public MainAdapterEx(Observable<Integer> scrollEventsObs,
